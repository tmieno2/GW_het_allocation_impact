...
+ This implies that LR may be able to enhance farming profit by devising allocation limits within the NRD that are increased (or decreased) based on spatial gradients in precipitation, while maintaining the same level of overall groundwater use as the current uniform allocation limit design.
